        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            <InfoCard
              ...
              title="Téléphone"
              body={
                <a href={PHONE_TEL_HREF} className="text-brand-red underline">
                  {PHONE_DISPLAY}
                </a>
              }
            />
            <InfoCard
              ...
              title="WhatsApp"
              body={
                <a href={wa} className="text-brand-red underline">
                  {PHONE_DISPLAY}
                </a>
              }
            />
            <InfoCard
              ...
              title="Email"
              body={
                <a href={`mailto:${CONTACT_EMAIL}`} className="text-brand-red underline">
                  {CONTACT_EMAIL}
                </a>
              }
            />
            ...
            <div className="flex gap-3 pt-2">
              <a
                ...
                className="rounded-full border border-black/10 px-4 py-2 text-sm font-heading font-semibold uppercase hover:border-brand-red"
              >
                Facebook
              </a>
              <a
